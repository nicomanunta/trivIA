...
@section('content')
    <body class="geography-bgcolor vh-100">
        <main class="vh-100">
            <div class="container vh-100 ">
                <div class="row align-content-center h-100">
                    <div class="col-12 mb-4 position-relative">
                        ...
                        <h1 class="category-name title-font text-center text-uppercase mb-3">Geografia </h1>
                        <div class="text-center"><i class="fa-solid fa-earth-americas"></i></div>
                    </div>
